...
// one surface (Ask). The developer-facing "Show the pipeline" disclosure under
// each answer is administrator-only; the public multi-step view is the Deep
// research sub-question list (decision recorded in docs/EPREPO.md). This
// route stays so old links/bookmarks keep working, and just forwards to Ask.
// ---------------------------------------------------------------------------

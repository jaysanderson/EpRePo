...
describe('merchandising overlays', () => {
  ...
  it('merchandiseCitation keeps a curated title and carries the generated headline as a subtitle', () => {
    ...
    const other = merchandiseCitation(store, 'frdc-2', citation, {
      title: 'FRDC project 1981-071 final report',
      titleCurated: true,
    })
    expect(other.title).toBe('FRDC project 1981-071 final report')

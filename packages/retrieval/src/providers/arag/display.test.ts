...
describe('looksLikeRawHashTitle', () => {
  ...
  it('does not flag a bare FRDC-style project code - that is an acceptable title', () => {
...
describe('deriveRelatedQuestions (query-aware "people also ask")', () => {
  const suggested: Question[] = [
    { id: 'q1', text: 'What does FRDC research say about abalone stock management?' },
    ...
    { id: 'q4', text: 'What does FRDC research say about abalone stock management?' },
  ]
  ...
  it('excludes the exact same question the user just asked', () => {
    const result = deriveRelatedQuestions(
      'What does FRDC research say about abalone stock management?',
      suggested,
    )

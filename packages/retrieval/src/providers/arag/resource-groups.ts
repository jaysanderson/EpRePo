...
/**
 * Identify only strong FRDC-style filename families. A title must begin with
 * a year/project code and then either be the primary report or carry one of
 * the corpus's observed variant markers. Ordinary prose containing "part",

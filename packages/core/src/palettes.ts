...
// 2026-08-31): original identities, deliberately distinct from client brand
// pairings (FRDC navy+teal, GRDC charcoal+green). Every palette must pass
// the PALETTE_CONTRACT below - palettes.test.ts enforces it, so a bad edit
// fails the build rather than shipping an illegible portal.
// ---------------------------------------------------------------------------

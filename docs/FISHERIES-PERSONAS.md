# Fisheries user taxonomy - who actually uses the FRDC portal

The people the FRDC tenant is tested as. `docs/PERSONAS.md` holds the two headline personas that
gate deploys (P1 fisheries scientist, P2 grains researcher); this document expands the fisheries
side into the full stakeholder set, because FRDC is a co-funded RDC whose audience is much wider
than research scientists, and a demo shown to FRDC will be poked at by all of them.

Derived from FRDC's actual stakeholder base: the Australian Government and the fishing and
aquaculture industry jointly fund it, and its remit spans commercial wild-catch, aquaculture,
recreational fishing, Indigenous fishing, the post-harvest supply chain, and the management
agencies that regulate all of the above.
...
**Who:** Dr Sarah, stock assessment scientist at a state fisheries agency or CSIRO; an FRDC
research provider.
...
**Who:** FRDC staff managing the research portfolio.
...
**Who:** not an FRDC user at all - a technical buyer, an external reviewer, a journalist, or the
Progress SE demoing the portal to a room that wants to catch it out.
**Job:** break it.

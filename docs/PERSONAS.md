...
pull evidence for a stock status brief; trace which projects informed a management decision.
**Representative journeys:**
1. Ask "What does FRDC research say about abalone stock management?" - expects a cited answer,
   clicks a citation through to the exact passage, saves evidence to an investigation.
...
## P2 - Grains agronomy researcher (GRDC tenant)
Dr Priya, cropping systems agronomist, GRDC-funded researcher.
**Jobs:** find prior GRDC investment on an agronomic problem; compare findings across regions;
assemble a briefing for growers.
**Representative journeys:**
1. Ask "What GRDC research covers stripe rust management in wheat?" - cited answer, citation
